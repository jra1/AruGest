...
public class Particular {
	...
	public Particular(Integer idparticular, Integer clienteID, String nombre,
			String apellidos, String nif) {
		super();
		this.idparticular = new SimpleIntegerProperty(idparticular);
