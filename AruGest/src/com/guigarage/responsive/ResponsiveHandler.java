...
public class ResponsiveHandler {
	...
	public static void addResponsiveToWindow(Window window) {
		...
		Util.registerRecursiveChildObserver(window, n -> removeAllPseudoClasses(n),
				n -> updatePseudoClasses(n, getTypeForWindow(window)));
	...
	public static void updatePseudoClassesForAllChildren(Window window) {
	...
	// ******************** Event handling *************************************
	public static final ObjectProperty<DeviceType> deviceTypeProperty = new ObjectPropertyBase<DeviceType>(
			DeviceType.NONE) {
		@Override
